  ...
  describe('.setFactory()', () => {
    describe('when called by not owner', () => {
      it('should revert', async () => {
        ...
        await expect(gateway.connect(context.accounts.anotherWallet).setFactory(context.factories.trexFactory.target))
          .to.be.revertedWithCustomError(gateway, 'OwnableUnauthorizedAccount')
          .withArgs(context.accounts.anotherWallet.address);
      });
    });
  ...
  describe('.setPublicDeploymentStatus()', () => {
    describe('when called by not owner', () => {
      it('should revert', async () => {
        ...
        await expect(gateway.connect(context.accounts.anotherWallet).setPublicDeploymentStatus(true))
          .to.be.revertedWithCustomError(gateway, 'OwnableUnauthorizedAccount')
          .withArgs(context.accounts.anotherWallet.address);
      });
    });
  ...
  describe('.transferFactoryOwnership()', () => {
    describe('when called by not owner', () => {
      it('should revert', async () => {
        ...
        await expect(gateway.connect(context.accounts.anotherWallet).transferFactoryOwnership(context.accounts.anotherWallet.address))
          .to.be.revertedWithCustomError(gateway, 'OwnableUnauthorizedAccount')
          .withArgs(context.accounts.anotherWallet.address);
      });
    });
  ...
  describe('.enableDeploymentFee()', () => {
    describe('when called by not owner', () => {
      it('should revert', async () => {
        ...
        await expect(gateway.connect(context.accounts.anotherWallet).enableDeploymentFee(true))
          .to.be.revertedWithCustomError(gateway, 'OwnableUnauthorizedAccount')
          .withArgs(context.accounts.anotherWallet.address);
      });
    });
