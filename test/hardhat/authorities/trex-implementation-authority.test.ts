  ...
  describe('.setTREXFactory()', () => {
    describe('When not called by the owner', () => {
      it('Should revert', async () => {
        ...
        await expect(trexImplementationAuthority.connect(anotherWallet).setTREXFactory(ethers.ZeroAddress))
  ...
  describe('.setIAFactory()', () => {
    describe('When not called by the owner', () => {
      it('Should revert', async () => {
        ...
        await expect(trexImplementationAuthority.connect(anotherWallet).setIAFactory(ethers.ZeroAddress))
          .to.be.revertedWithCustomError(trexImplementationAuthority, 'OwnableUnauthorizedAccount')
          .withArgs(anotherWallet.address);
      });
    });
  ...
  describe('.addTREXVersion()', () => {
    describe('when called not as owner', () => {
      it('should revert', async () => {
        ...
        await expect(trexImplementationAuthority.connect(anotherWallet).addTREXVersion(versionStruct, contractsStruct))
          .to.be.revertedWithCustomError(trexImplementationAuthority, 'OwnableUnauthorizedAccount')
          .withArgs(anotherWallet.address);
      });
    });
  ...
  describe('.useTREXVersion()', () => {
    describe('when called not as owner', () => {
      it('should revert', async () => {
        ...
        await expect(trexImplementationAuthority.connect(anotherWallet).useTREXVersion(versionStruct))
          .to.be.revertedWithCustomError(trexImplementationAuthority, 'OwnableUnauthorizedAccount')
          .withArgs(anotherWallet.address);
      });
    });
